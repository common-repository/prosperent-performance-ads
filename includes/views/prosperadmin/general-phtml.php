...
echo '<p class="prosper_settingDesc">' . __( 'Go to <a href="http://wordpress.prosperentdemo.com/performance-ads/">WordPress Prosperent Demo: ProsperAds</a> for more information and tutorials.', 'prosperent-suite' ) . '</p>';
